...
1. [Cloud foundations](01-cloud-foundations.md) follows one request through DNS, routing, load balancing, compute, identity, and storage. It supplies the AWS vocabulary used by every later note.
2. [Containers and the Kubernetes object model](02-containers-and-kubernetes-objects.md) turns the application process into an image, Pod, and controller-owned workload.
